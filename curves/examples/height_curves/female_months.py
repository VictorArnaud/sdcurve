class HeightCurveFemaleMonths(object):
    ...
    def make(self):
        ...
        return {
            ...
            'percentis_3': [41.54, 44.24, 46.88, 49.40, 51.74, 53.89, 55.84, 57.60,
            ...
            'percentis_10': [43.84, 46.51, 49.13, 51.62, 53.94, 56.07, 58.00, 59.73,
            ...
            'percentis_25': [45.87, 48.57, 51.21, 53.73, 56.06, 58.19, 60.12, 61.85,
            ...
            'percentis_50': [47.70, 50.46, 53.16, 55.72, 58.10, 60.26, 62.21, 63.95,
            ...
            'percentis_75': [49.37, 52.22, 54.99, 57.63, 60.06, 62.27, 64.26, 66.04,
            ...
            'percentis_90': [50.91, 53.85, 56.73, 59.45, 61.96, 64.24, 66.29, 68.12,
            ...
            'percentis_97': [52.34, 55.39, 58.37, 61.20, 63.80, 66.17, 68.29, 70.18,
