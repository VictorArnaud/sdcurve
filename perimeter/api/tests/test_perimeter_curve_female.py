...
class PerimeterCurveFemaleTestCase(APITestCase):
    """
    Test to show the cephalic perimeter based growth curve for females aged 0
    to 24 months
    """
    ...
    def setUp(self):
        ...
        self.url = reverse('perimeter:curve-female')
