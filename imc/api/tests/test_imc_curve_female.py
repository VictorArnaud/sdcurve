...
class IMCCurveFemaleTestCase(APITestCase):
    """
    Test to show the IMC based growth curve for females aged 2
    to 18 years
    """
    ...
    def setUp(self):
        ...
        self.url = reverse('imc:curve-female')
