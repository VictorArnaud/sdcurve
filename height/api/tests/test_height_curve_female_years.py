...
class HeightCurveFemaleYearsTestCase(APITestCase):
    """
    Test to show the height-based growth curve for females aged 3 to 20 years
    """
    ...
    def setUp(self):
        ...
        self.url = reverse('height:curve-female-years')
