...
class WeightCurveFemaleMonthsTestCase(APITestCase):
    """
    Test to show the weight-based growth curve for females aged 0 to 36 months
    """
    ...
    def setUp(self):
        ...
        self.url = reverse('weight:curve-female-months')
